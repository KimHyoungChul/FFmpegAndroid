...
public class SimpleFFmpegPlayerActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.simple_ffmpeg_player);
    ...
    private void initView() {
        ...
        tvDstfile.setText(getResources().getString(R.string.simple_ffmpeg_player_filename));
